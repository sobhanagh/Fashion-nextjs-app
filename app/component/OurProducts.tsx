    ...
    const images: imageType[] = [
        {
            ...
            srcPerson: "/our_products/person_1.svg",
            title: "Spread Collar Shirt",
            price: "$48.99 | 5.0"
        },
        {
            srcBackground: "/our_products/Rectangle_5.svg",
            srcPerson: "/our_products/person_5.svg",
            title: "White Solid Formal Shirt",
            price: "$38.00 | 4.9"
        },
        {
            srcBackground: "/our_products/person_3.svg",
            srcPerson: "/our_products/person_3.svg",
            title: "Shine On Me Blouse",
            price: "$42.99 | 4.8"
        },
        {
            srcBackground: "/our_products/Rectangle_4.svg",
            srcPerson: "/our_products/person_4.svg",
